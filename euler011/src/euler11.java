...
public class euler11 {
   ...
   static void initializeGrid(int gridSize){
    ...
    static void gridPrint() {
        for (int y = grid.length-1; y >= 0; y--) {
            for (int x = 0; x < grid.length; x++) {
                System.out.printf("%d  y", grid[x][y]);
            }
            System.out.printf("\n");
        }
    }
    ...
    static long largestAdjencentProductOf(int[][] grid, int adjacentDigits){
        long max = 0;
        long product = 0;
        for (int y = grid.length-1; y >= 0; y--) {
            for (int x = 0; x < grid.length; x++) {
    ...
    public static void main(String[] argv){
        ...
        //gridPrint();
        System.out.println(largestAdjencentProductOf(grid,4));
